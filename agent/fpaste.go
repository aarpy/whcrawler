// Package agent wraps the basic functions of the fpaste.org API and exposes a
// Go API.
// source: https://github.com/bearbin/go-paste/blob/master/fpaste/fpaste.go
package agent
...
func (f Fpaste) Put(text, title string) (id string, err error) {
	...
	if resp.StatusCode != 200 {
		return "", errors.New("Fpaste put failed")
	}
